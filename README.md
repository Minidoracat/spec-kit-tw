...
[![Current Version](https://img.shields.io/badge/version-0.0.3-green)](https://github.com/Linfee/spec-kit-cn/releases)
...
- [📋 详细流程](#-详细流程)
  - [**步骤1：** 引导项目](#步骤1-引导项目)
  - [**步骤2：** 功能规范澄清](#步骤2-功能规范澄清)
  - [**步骤3：** 生成计划](#步骤3-生成计划)
  - [**步骤4：** 让Claude Code验证计划](#步骤4-让claude-code验证计划)
  - [步骤5：实施](#步骤5实施)
- [🔍 故障排除](#-故障排除)
